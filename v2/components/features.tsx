...
export function Features() {
  return (
    ...
    >
      {/* <Header> */}
        <h2 className="font-sans text-bold text-2xl text-center md:text-4xl w-fit mx-auto font-bold tracking-tight text-neutral-8000 dark:text-neutral-100 text-neutral-800">
          Quality research without the headache
        </h2>
      {/* </Header> */}
      ...
      <div className="mt-20 grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            <CardTitle>Start Semantic</CardTitle>
            <CardDescription>
              Heighliner's semantic input interface allows your team to research at the speed of thought.
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Transferable Artifacts</CardTitle>
            <CardDescription>
              With a single click, Heighliner can instantly create transferable artifacts from the compiled research.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Security and Privacy First</CardTitle>
            <CardDescription>
              Documents and searches are never stored, encryption at every step, and your team can delete their history at any time.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <SkeletonTwo />
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-40">
            <CardTitle>In-document Analysis</CardTitle>
            <CardDescription>
              Upload any amount of documents of any size and quickly extract key language, precedent, and relevant citations.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2 overflow-hidden">
  ...
  return (
    <div className="relative flex items-center justify-center  w-full h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-lg mx-auto w-full relative z-30 [perspective:1000px] [transform-style:preserve-3d] p-8 sm:p-0">
        ...
        >
          <p className="text-[10px] bg-transparent">
            Cases that are comparable or distinguishable to determining whether Maria Rivera, who composed music for the Academie Dance Studio was an employee or an independent contractor.
          </p>
        </Container>
        <Container
          initial={{ y: 0 }}
        ...
        >
          <div className="flex items-center">
            <Image
              ...
              width={800}
              height={800}
              className="h-10 w-10 object-contain text-black dark:text-white"
            />
            <span className="ml-2 text-sm text-black dark:text-white">Heighliner</span>
          </div>
        </Container>
        <Container
          initial={{ y: 0 }}
        ...
        >
          <div className="flex space-x-2">
            <Image
              src="/pictures/Westlaw+TR+Logo.png"
              alt="icon"
              width={1200}
              height={1200}
              className="h-14 w-14 md:h-15 md:w-15 object-contain text-black dark:text-white"
            />
            <Image
              src="/pictures/LexisNexis_logo.svg"
              alt="icon"
              width={800}
              height={800}
              className="h-14 w-14 md:h-15 md:w-15 object-contain text-black dark:text-white"
