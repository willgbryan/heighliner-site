    ...
    >
      <div className="max-w-7xl mx-auto 0 flex flex-col md:flex-row justify-between items-center w-full">
        <div className="flex flex-col">
          <motion.h2 className="text-black dark:text-white text-2xl text-left md:text-3xl font-bold mx-auto md:mx-0 max-w-xl pb-8">
            Empower your team <br />
            with a true legal search engine.
          </motion.h2>
          {/* <p className="max-w-md mt-8 text-center md:text-left text-sm md:text-base mx-auto md:mx-0 text-neutral-600 dark:text-neutral-400">
            ...
            Experience unparalleled sematic search, resource collection, 
          </p> */}
          {/* <FeaturedImages
        ...
        <button
          ...
          className="flex space-x-2 items-center group text-base px-4 py-2 rounded-lg bg-gradient-to-b from-slate-500 to-slate-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]"
        >
